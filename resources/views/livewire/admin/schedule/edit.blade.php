<div class="row my-2 py-4">
    ...
    <div class="col-12 bg-white shadow-lg rounded-lg p-3">
        <form id="js-form" action="{{route("admin-schedule.update",$schedule->id)}}" method="post" enctype="multipart/form-data">
            @method('PUT')
            ...
            <div class="form-group"  wire:ignore>
                ...
                <div>
                    <input id="start_date"  wire:model="start_at" class="form-control my-date @error('start_at') is-invalid @enderror" name="start_at" type="text" value="{{$start_at}}" >
                </div>
            </div>
            <div class="form-group" wire:ignore>
                <label for="example-text-input" class=" col-form-label">Дата окончания *</label>
                <div>
                    <input id="end_date"  wire:model="end_at" class="form-control my-date  @error('end_at') is-invalid @enderror" name="end_at" type="text" value="{{$end_at}}" >
                </div>
            </div>
