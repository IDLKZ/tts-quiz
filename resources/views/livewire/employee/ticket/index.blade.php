                    ...
                    <div id="accordion-open-body-1" class="" aria-labelledby="accordion-open-heading-1">
                        <div class="p-3 border border-b-0 border-gray-200">
                            <div class="flex items-center align-items-center">
                                <input wire:model="is_resolved" checked id="checked-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="checked-checkbox" class="m-2 text-sm font-medium text-gray-900 dark:text-gray-300">Вопрос решен</label>
                            </div>
                        </div>
                    </div>
                </div>
