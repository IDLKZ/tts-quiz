                                ...
                                <form id="js-form" class="form-horizontal" action="{{route('restore')}}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="mt-4">
                                                <button class="btn btn-success bg-green-300 btn-block waves-effect waves-light" type="submit">Восстановить</button>
                                            </div>
                                            <div class="my-2 py-2">
                                                <a href="{{route("login")}}" class="text-muted"><i class="mdi mdi-power"></i> Вход в личный кабинет</a>
                                            </div>
