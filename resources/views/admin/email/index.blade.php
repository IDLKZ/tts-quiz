            ...
            <div class="page-title-box">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Список почт</h4>
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/admin">Главная</a></li>
                                <li class="breadcrumb-item active">Список почт</li>
                            </ol>
                        </div>
                        <div class="col-md-4">
                            <div class="float-right d-none d-md-block">
                                <div class="dropdown">
                                    <a href="{{route("email.create")}}" class="btn btn-light btn-rounded dropdown-toggle">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a href="{{route("email.edit",$email->id)}}" class="btn btn-outline-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                    ...
                                    @else
                                        <p class="font-size-16 text-danger">Почтовых адресов еще нет</p>
                                    @endif
                                </div>
                            </div>
                        </div> <!-- end col -->
